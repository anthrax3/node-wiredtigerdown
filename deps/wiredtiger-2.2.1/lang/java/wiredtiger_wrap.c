...
SWIGINTERN int __wt_cursor_java_init(struct __wt_cursor *self,jobject jcursor){
...
SWIGINTERN int __wt_async_op_java_init(struct __wt_async_op *self,jobject jasyncop){
		JAVA_CALLBACK *jcb =
...
SWIGINTERN int __wt_session_java_init(struct __wt_session *self,jobject jsess){
...
SWIGINTERN int __wt_connection_java_init(struct __wt_connection *self,jobject jsess){
...
SWIGINTERN WT_ASYNC_OP *__wt_connection_async_new_op_wrap(struct __wt_connection *self,JNIEnv *jenv,char const *uri,char const *config,jobject callbackObject){
		...
		jcb->jcallback = (*jcb->jnienv)->NewGlobalRef(jcb->jnienv, callbackObject);
		(*jcb->jnienv)->DeleteLocalRef(jcb->jnienv, callbackObject);
...
SWIGEXPORT jlong JNICALL Java_com_wiredtiger_db_wiredtigerJNI_Cursor_1session_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  (void)jarg1_;
  {
    ...
    /*@SWIG:wiredtiger.i,157,NULL_CHECK@*/
    if (!arg1) {
...
SWIGEXPORT jint JNICALL Java_com_wiredtiger_db_wiredtigerJNI_Cursor_1java_1init(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jobject jarg2) {
  ...
  arg2 = jarg2; 
  result = (int)__wt_cursor_java_init(arg1,arg2);
...
SWIGEXPORT jlong JNICALL Java_com_wiredtiger_db_wiredtigerJNI_AsyncOp_1getId(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  struct __wt_async_op *arg1 = (struct __wt_async_op *) 0 ;
  WT_ASYNC_OP *arg2 = (WT_ASYNC_OP *) 0 ;
  uint64_t result;
...
SWIGEXPORT jint JNICALL Java_com_wiredtiger_db_wiredtigerJNI_AsyncOp_1java_1init(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jobject jarg2) {
  ...
  arg2 = jarg2; 
  result = (int)__wt_async_op_java_init(arg1,arg2);
...
SWIGEXPORT jint JNICALL Java_com_wiredtiger_db_wiredtigerJNI_Session_1java_1init(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jobject jarg2) {
  ...
  arg2 = jarg2; 
  {
    result = (int)__wt_session_java_init(arg1,arg2);; 
  }
...
SWIGEXPORT jint JNICALL Java_com_wiredtiger_db_wiredtigerJNI_Connection_1java_1init(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jobject jarg2) {
  ...
  arg2 = jarg2; 
  {
    result = (int)__wt_connection_java_init(arg1,arg2);; 
  }
